...
#define ST25R_SS_PIN                     5                 /*!< GPIO pin used for ST25R SPI SS                    */
...
#define ST25R_INT_PIN               4                     /*!< GPIO pin used for ST25R External Interrupt         */
...
#define platformGpioToggle(port, pin)                 (platformGpioIsHigh(port, pin) ? platformGpioClear( port, pin) : platformGpioSet(port, pin))  /*!< Toggles the given GPIO    */
...
#define platformDelay(t)                              delay((t))                                        /*!< Performs a delay for the given time (ms)    */
...
#define platformLog(...)                              do { log_impl.printf(__VA_ARGS__); fflush(stdout); } while(0);    /*!< Log  method                                 */
