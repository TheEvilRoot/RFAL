 ...
 *  
 *  It provides the functionality to use a GPIO line to receive interrupts from ST25R
 ...
 * to receive interrupts from ST25R.
 *
...
/*! 
 *****************************************************************************
 * \brief  To protect RFAL Worker
 *  
 * This method acquire a mutex before executing RFAL Worker
 * 
 *****************************************************************************
 */
 ...
 * \brief  To protect interrupt status variable  of RFAL 
 *  
 * This method release the mutex after executing RFAL Worker
 * 
 *****************************************************************************
 */
